...
export default function MainLayout({
  ...
  return (
    <main className="relative w-full bg-gray-950 text-white overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative w-full h-[80vh] flex flex-col justify-center items-center text-center overflow-hidden">
        {/* Background Image */}
        {backgroundImage && (
          <div
